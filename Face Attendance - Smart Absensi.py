...
def selesai1():
    intructions.config(text="Rekam Data Selesai!")
def selesai2():
...
def rekamDataWajah():
    ...
    while True:
        ...
        if cv2.waitKey(1) & 0xFF == ord('x'):  #menekan tombol x akan berhenti
            break
        elif ambilData > 30:
            break
    selesai1()
...
# judul
judul = tk.Label(root, text="Face Attendance", font=("Roboto",34),bg="#242526", fg="white")
canvas.create_window(350, 80, window=judul)
#credit
made = tk.Label(root, text="Edited By Kelompok 5", font=("Times New Roman",13), bg="black",fg="white")
